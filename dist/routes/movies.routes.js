...
router.get("/movies/filter", authToken_1.auhToken, validator.moviesFilter, controller.filter);
router.get("/movies/:id", authToken_1.auhToken, validator.movieID, controller.search);
...
router.delete("/movies/:id", authToken_1.auhToken, validator.movieID, controller.delete);
